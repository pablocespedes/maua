...
(function ($) {
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if ($YouTubeModal == null) {
                $YouTubeModal = $('<div class="video-container modal fade ' + options.cssClass + '" id="YouTubeModal" role="dialog" aria-hidden="true">');
                var modalContent = '<div class="modal-dialog" id="YouTubeModalDialog">'+
										'<div class="modal-content" id="YouTubeModalContent">'+
											...
											'</div>'+
											'<div class="modal-body" id="YouTubeModalBody" style="padding:0px 4px 0px 4px;"></div>'+
										'</div>'+
									'</div>';
    ...
    function getYouTubePlayer(URL, width, height) {
        ...
        YouTubePlayer += 'style=" margin:0; padding:0; box-sizing:border-box; border:0; -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px;" ';
