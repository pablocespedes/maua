practiceGame.controller('QuestionController',['$scope','practiceSrv','Utilities','breadcrumbs','practiceRequests','Alerts',
  function($scope,practiceSrv,Utilities,breadcrumbs,practiceRequests,Alerts) {
