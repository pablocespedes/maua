practiceGame.controller('PracticeController',['$scope','practiceRequests','Utilities','breadcrumbs','VideoService','Alerts','$route','$location','newQuestionObject',function($scope,practiceRequests,Utilities,breadcrumbs,VideoService,Alerts,$route,$location,newQuestionObject) {
