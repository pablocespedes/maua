(function() {
  'use strict';
    angular.module('ui.accordion', ['ui.bootstrap.collapse'])
        ...
        .directive('accordionHeading', accordionHeading)
        .directive('accordionTransclude', accordionTransclude);
    ...
    function accordion() {
        var directive = {
            ...
            transclude: true,
            replace: false,
          templateUrl: 'app/components/accordion/templates/accordion.html'
        };
        return directive;
    }
    ...
    function accordionGroup() {
        ...
        var directive = {
            ...
            templateUrl: 'app/components/accordion/templates/accordion-group.html',
            scope: {
